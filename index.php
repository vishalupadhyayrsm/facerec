...
<body class="bg-slate-800 ">
    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 lg:mx-20">
        <div class="w-10/12 h-auto mx-9 space-y-4 mb-1 sm:w-full sm:h-auto sm:m-1 md:w-96  lg:w-11/12 lg:mb-0 xl:11/12">
       ...
       <!-- outpurt will be shown here -->
        <div class="w-10/12 h-auto mx-9 space-y-4  mb-1 sm:w-full sm:h-auto sm:m-1 md:w-10/12 lg:w-11/12 lg:mb-0  xl:11/12">
    ...
    <div class="mx-20 sm:w-2/3 sm:mx-64  md:mx-56 lg:mx-96 xl:mx-96">
        <img src="image/bar.png"    class="float-left w-8 mx-2.5 sm:w-20 h-16 sm:mx-1 md:mx-3 lg:mx-4 2xl:mx-8" id="btnScanner"/>
        <img src="image/camera.png" class="float-left w-8 mx-2.5 sm:w-20 h-16 sm:mx-1 md:mx-3 lg:mx-4 2xl:mx-8" id="btnCapture" onclick="captureImage()" />
